...
- While ACE is in v0, breaking changes are allowed in any release, including patches.
  From v1 onward, renames add the new name + `#[command(visible_alias = "...")]`;
  removals require a major bump. Every removal requires a release note.
