...
ENTRY
  ...
  # without the caller having to remember an env var. Soft containment — a
  # backend that ignores these vars still reaches the host.
  {
    echo "#!/bin/sh"
